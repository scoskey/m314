...
4. Modify a proof given in class to instead show that the cut $\set{q\in\Q\mid q^3<2}$ has no last element.
5. (Abbott, ex 8.6.3) Read the definition of a "field" of numbers and note the list of properties which must be true of a field. Which of these properties are satisfied in $\N$? In $\Z$? In $\Q$?
