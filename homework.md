...
1. (Abbott, ex 1.4.4) Let $a<b$ and $T=\math{Q}\cap[a,b]$. Show $\sup(T)=b$.
...
3. (Abbott, ex 1.4.6) We say that a set $D$ is *dense* in $\mathbb{R}$ if between any two real numbers we can find an element of $D$. Which of the following are dense, and why?  
