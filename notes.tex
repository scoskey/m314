...
\begin{proof}
  Suppose towards a contradiction that the set of irrational numbers is countable. Then $\RR=\QQ\bigcup(\RR\setminus\QQ)$ is countable, being the union of two countable sets, contradicting the theorem.
\end{proof}
