...
On the other hand, the cut at $\sqrt{2}$ considered previously would formally be defined as $C=\set{q\in\QQ\mid q<0\text{ or }q^2<2}$. This is an example of an irrational cut.
...
\item $\QQ$: you can add, subtract, and divide, but there are ``gaps''.
\end{itemize}
