...
\begin{proof}
  ...
  Meanwhile all that remains of the sequence is the finite initial segment $a_1,\ldots,a_N$. Since finite sets are always bounded between their minimum and maximum element, we may say that this initial segment is contained in some interval $[c,d]$. It follows that the full sequence is contained in the interval $[\min(a,c),\max(b,d)]$ and therefore is bounded.
\end{proof}
