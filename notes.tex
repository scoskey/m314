...
\begin{activity}
  ...
  \begin{enumerate}
    ...
    \item What can you say about the product of two irrational numbers?
  \end{enumerate}
...
\begin{exerc}[Abbott, exercise 1.4.5]
  Prove the statement known as \emph{irrational density}: for every two real numbers $a$ and $b$ with $a<b$, there exists an \emph{irrational} number $r$ satisfying $a<r<b$.
\end{exerc}
