...
\begin{activity}
  ...
  \end{enumerate}
  \item In each case, prove the given sequence \emph{does not} converge to the proposed limit directly from the negation of the definition of convergence.
  \begin{enumerate}
...
\begin{activity}
  ...
  \begin{enumerate}\itemsep 5pt
    ...
    \item $\lim\frac{\sqrt{n^2+1}}{n-2}$ (you may use that limits pass through $\sqrt{\ }$)
