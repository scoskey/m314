...
\begin{exerc}[see Abbott, ex 8.4.1]
...
\begin{exerc}[Abbott, ex 1.2.1]
  ...
  \item Obviously there \emph{is} a rational number such that $r^2=4$, so your proof in part (a) cannot work if $3$ is replaced by $4$.  But where does the proof actually break down?
  \end{enumerate}
\end{exerc}
