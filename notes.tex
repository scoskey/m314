...
We may now conclude that if $(A,\emptyset,B)$ is the cut at $\sqrt2$, then $A$ has no rational supremum. Indeed if $\alpha$ were the supremum of $A$, then since $A$ has no greatest element we have $\alpha\notin A$. Similarly since $B$ has no least element we have $\alpha\notin B$. Thus $\alpha\notin\Q$.
