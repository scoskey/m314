...
\begin{activity}
  \item Let $A$ be the set of integer lattice points in the plane, that is, $A=\set{(x,y):x,y\in\Z}$. Draw a picture of the set $A$. Show $A$ is countable by showing how to write all its elements in a list. (Write the first 6--10 elements, and explain how you would continue.)
  \vspace\fill
