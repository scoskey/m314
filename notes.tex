...
\begin{activity}
  ...
  \begin{enumerate}
    \item A Cauchy sequence that is not monotone\vspace{1in}
    \item A monotone sequence that is not Cauchy\vspace{1in}
    \item A Cauchy sequence with a divergent subsequence\vspace{1in}
